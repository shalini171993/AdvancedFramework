...
public class TestConfig{
	...
	public static String from = "shalinibas0@gmail.com";
	public static String password = "Google@123";
	public static String[] to ={"shalinibaskaran17@gmail.com"};
	public static String subject = "Automation Project Extent Report";
